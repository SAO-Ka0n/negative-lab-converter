...
- 안정 랜딩 페이지: https://sao-ka0n.github.io/negative-lab-converter/
- 프리뷰 릴리스: https://github.com/SAO-Ka0n/negative-lab-converter/releases/tag/v0.1.0-preview-20260406
- 개인 구매 요청: https://github.com/SAO-Ka0n/negative-lab-converter/issues/new?template=purchase-request.yml
- 팀 라이선스 / 인보이스 요청: https://github.com/SAO-Ka0n/negative-lab-converter/issues/new?template=team-license-request.yml
- 지원 요청: https://github.com/SAO-Ka0n/negative-lab-converter/issues/new?template=support-request.yml

현재 공개 빌드는 프리뷰 단계이며, Windows 빌드는 unsigned, macOS 빌드는 notarization 전 상태입니다.
...
실파일 회귀 코퍼스는 `qa/README.md` 기준으로 관리합니다.
- 공개 저장소용 기본 파일: `qa/corpus.manifest.json`
- 이 머신의 실파일 검증용: `qa/corpus.manifest.local.json` (git ignored)

실제 판매값 주입용 최소 템플릿은 `COMMERCIAL_RELEASE.local.env.template`에 정리했습니다. 예:

```bash
cp COMMERCIAL_RELEASE.local.env.template COMMERCIAL_RELEASE.local.env
```

`COMMERCIAL_RELEASE.local.env`에 아래 값을 채운 뒤:

```bash
# NLC_SUPPORT_EMAIL="support@your-domain.com"
# NLC_PURCHASE_URL="https://your-store.lemonsqueezy.com/buy/negative-lab-converter"
# NLC_WINDOWS_DOWNLOAD_URL="https://downloads.example.com/Negative%20Lab%20Converter%20Setup%200.1.0.exe"
# NLC_MAC_DOWNLOAD_URL="https://downloads.example.com/Negative%20Lab%20Converter-0.1.0-arm64.dmg"
# CSC_LINK="file:///absolute/path/to/windows-codesign-cert.p12"
# CSC_KEY_PASSWORD="your-windows-cert-password"
# APPLE_ID="your-apple-id@example.com"
# APPLE_APP_SPECIFIC_PASSWORD="xxxx-xxxx-xxxx-xxxx"
# APPLE_TEAM_ID="TEAMID1234"

set -a
source COMMERCIAL_RELEASE.local.env
set +a
...
실제 값 주입과 서명 준비 순서는 `COMMERCIAL_RELEASE_SETUP.md`에 정리했습니다.
